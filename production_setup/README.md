...
| `AI_BACKEND_ALLOWED_PRIVATE_HOSTS` | No | none in production | Comma-separated exact hostnames allowed to resolve to private-network AI backends; add only trusted internal model servers |
